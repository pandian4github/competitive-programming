...
void zerocalc(int d,long int arr[])
 {
   int p=1;
   while(d>0)
    {
...
void zerocplx2(int d,int d1,long int a1,long int arr[])
 {
   int i;
   long int p=1;
   for(i=0;i<d1;i++)
...
void zerocplx1(int d,int d1,long int a1,long int arr[])
 {
   int i;
   long int p=1;
   for(i=0;i<d1;i++)
...
void recursum(long long int a,long long int b,int d,long int arr[])
 {
   int i,j,d1,d2,f1,f2;
   int c1=0,c2=0;
   long int a1,b1;
